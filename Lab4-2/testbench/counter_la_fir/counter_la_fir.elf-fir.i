# 0 "fir.c"
# 1 "/home/ubuntu/SoC/lab4-2/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "fir.c"
# 1 "fir.h" 1
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir() {
    ...
    int test;
    if((*(volatile uint32_t*)0x30000000) & 0b100) {
     (*(volatile uint32_t*)0x30000010) = 600;
     volatile uint32_t* tap_addr = ( volatile uint32_t*)0x30000040;
 ...
 while(!((*(volatile uint32_t*)0x30000000) & 0b10)) continue;
    }
